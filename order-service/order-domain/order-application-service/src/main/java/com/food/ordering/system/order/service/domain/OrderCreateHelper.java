...
public class OrderCreateHelper {
    ...
    @Transactional
    public OrderCreatedEvent persistOder(CreateOrderCommand createOrderCommand) {
    ...
    private Restaurant checkRestaurant(CreateOrderCommand createOrderCommand) {
        ...
        Optional<Restaurant> rest = restaurantRepository.findRestaurantInformation(restaurant);
        if(rest.isEmpty()) {
            log.warn("Could not find restaurant with customer id: {}", restaurant.getId());
