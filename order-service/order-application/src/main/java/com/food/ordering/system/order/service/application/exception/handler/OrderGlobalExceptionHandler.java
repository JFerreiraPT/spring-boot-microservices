...
public class OrderGlobalExceptionHandler  extends GlobalExceptionHandler {
    ...
    public ErrorDTO handleExceptions(OrderDomainException orderDomainException) {
    ...
    public ErrorDTO handleExceptions(OrderNotFoundException orderNotFoundException) {
