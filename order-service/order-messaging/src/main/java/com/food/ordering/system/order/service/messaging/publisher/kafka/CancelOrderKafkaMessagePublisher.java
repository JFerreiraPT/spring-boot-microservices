...
public class CancelOrderKafkaMessagePublisher implements OrderCancelledPaymentRequestMessagePublisher {
    ...
    private final OrderKafkaMessagingHelper orderKafkaMessagingHelper;


    public CancelOrderKafkaMessagePublisher(OrderMessagingDataMapper orderMessagingDataMapper,
                                            OrderServiceConfigData orderServiceConfigData,
                                            KafkaProducer<String, PaymentRequestAvroModel> kafkaProducer, OrderKafkaMessagingHelper orderKafkaMessagingHelper) {
        this.orderMessagingDataMapper = orderMessagingDataMapper;
        this.orderServiceConfigData = orderServiceConfigData;
        this.kafkaProducer = kafkaProducer;
        this.orderKafkaMessagingHelper = orderKafkaMessagingHelper;
    }
    ...
    public void publish(OrderCancelledEvent domainEvent) {
        ...
        try{
            ...
            kafkaProducer.send(orderServiceConfigData.getPaymentRequestTopicName(),
                    ...
                    this.orderKafkaMessagingHelper.getKafkaCallback(orderServiceConfigData.getPaymentResponseTopicName(),
